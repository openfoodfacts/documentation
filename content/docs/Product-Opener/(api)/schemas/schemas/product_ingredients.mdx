...
description: Schema definition for the Product-Ingredients object in product data
full: true
---

# Product-Ingredients Schema

This is a **data schema**, not an API endpoint. The `Product-Ingredients` object describes the shape of
