...
description: Schema definition for the Product-Metadata object in product data
full: true
---

# Product-Metadata Schema

This is a **data schema**, not an API endpoint. The `Product-Metadata` object describes the shape of
