---
title: "Explain Dynamic Test Grouping System"
---
...
```bash title="Manual Group Generation"
...
```python title="Target Execution Time"
...
```python title="Default Test Time"
# In scripts/dynamic_test_grouper.py
...
```text title="Performance Reports"
# Group Statistics:
...
```bash title="Missing Timing Data"
