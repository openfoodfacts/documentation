---
title: "How to Add a Generic Recommendation Panel for a Category"
---
...
```properties title="Step 1: Add Properties to the Category Taxonomy"
...
```po title="Step 2: Add the Display Strings"
...
```properties title="(Optional) Creating Country-Specific Recommendations"
...
```po title="(Optional) Creating Country-Specific Recommendations"
